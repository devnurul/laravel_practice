...
<body>
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="index.html">Nurul Islam Admin</a>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									<a href="#"><i class="icon-indent-decrease2"></i> <span>Posts</span></a>
									<ul>
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<div class="footer text-muted">
						&copy; 2022. <a href="#">all right reserve</a> by <a href="https://devnurul.me" target="_blank">Dev Nurul</a>
					</div>
					<!-- /footer -->
	...
	<script type="text/javascript" src="{{ ('admin/
